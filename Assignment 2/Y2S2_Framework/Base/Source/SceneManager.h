...
public:
	...
	void PreRendering(Mtx44 translate, bool enableLight);
	...
	Mesh* IfGridEmpty(const int xIndex, const int yIndex);
	Mesh* IfGridNotEmpty(const int xIndex, const int yIndex);
