...
const float m_fTPVCameraOffset = 100.0f;			//offset dis from the camera
...
/********************************************************************************
Update the camera for 3rd Person View
Vector3 newPosition is the new position which is camera is based on
********************************************************************************/
void Camera3::UpdatePosition(Vector3 newPosition, Vector3 newDirection)
{
	...
	//position.y += m_fTPVCameraOffset * 0.2;
