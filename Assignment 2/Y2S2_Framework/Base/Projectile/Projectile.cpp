...
// Set the lifetime of the CBulletInfo instance
void CProjectile::SetLifetime(const float Lifetime)
{
	this->LifeTime = Lifetime;
}

// Get the lifetime of CBulletInfo instance
float CProjectile::GetLifetime(void)
{
	return LifeTime;
}